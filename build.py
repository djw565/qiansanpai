...
<nav class="nav-bar">
  <div class="filter-tags">
    <a href="index.html" class="filter-tag active">全部</a>
    <a href="index.html" class="filter-tag">职场</a>
    <a href="index.html" class="filter-tag">情感</a>
    <a href="index.html" class="filter-tag">原生家庭</a>
    <a href="index.html" class="filter-tag">思维方法</a>
    <a href="index.html" class="filter-tag">心理</a>
    <a href="index.html" class="filter-tag">社会</a>
  </div>
</nav>
