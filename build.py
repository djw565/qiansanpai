...
def classify_tags(title: str) -> list:
    ...
    # 关键词匹配
    keywords = {
        '职场': ['职场', '升职', '公司', '工作', '领导', '同事', '体制内', '体制外', '外企', '国企', '空降', '管理', '上班', '老板', '打工', '加班', '内卷', '躺平', '大厂', '年薪', '项目', '退休', '赚钱', '收入'],
        '情感': ['爱', '恋', '婚', '情', '男友', '女友', '老公', '老婆', '妻子', '丈夫', '夫妻', '分手', '绝交', '暧昧', '约会', '相亲', '彩礼', '赘婿', '去父留子', '被骗', '不爱', '离开', '好人', '恋爱', '救赎', '出口'],
        '原生家庭': ['父母', '父亲', '母亲', '妈妈', '爸爸', '公婆', '女儿', '儿子', '孩子', '家庭', '原生', '亲子', '母女', '父子', '代孕', '婆婆', '丈夫', '妻子'],
        '思维方法': ['思维', '方法', '逻辑', '一阶', '二阶', '三阶', '辩证', '唯物主义', 'ORID', '模型', '系统', '规律', '举一反三', '成长', '习惯', '闭环', '飞轮', '定位', '退休', '复盘', '分析'],
        '社会': ['社会', '女权', '阶层', '消费主义', '历史', '文化', '政治', '国家', '法律', '体制', '自由', '权力', '资本', '金融', '经济', '财富', '骗局'],
        '心理': ['心理', '焦虑', '抑郁', '自我攻击', 'PUA', '人格', '讨好', 'ADHD', '习得性无助', '内耗', '精神', '情绪', '创伤', '满足', '自信', '迷茫', '提醒', '自欺', '失控', '健康'],
    }
...
<nav class="nav-bar">
  <div class="filter-tags">
    ...
    <a href="guide.html" class="filter-tag">📋 使用指南</a>
    <a href="concepts.html" class="filter-tag" style="background:#6b5ce7;color:#fff;border-color:#6b5ce7;">📖 概念库</a>
    <a href="agent.html" class="filter-tag" style="background:#c44d4d;color:#fff;border-color:#c44d4d;">💬 子休问答</a>
  </div>
</nav>

<main class="main-content">
  <div id="daily-quote" class="daily-quote">
    <div class="daily-quote-label">✦ 概念复习</div>
